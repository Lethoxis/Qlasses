...
execute as @e[tag=projectile,tag=blitz_dash,scores={life=18..}] at @s run particle dust 1 1 0 1 ^ ^.9 ^ .2 .2 .2 .02 20
execute as @e[tag=projectile,tag=blitz_dash,scores={life=18..}] at @s run particle angry_villager ^ ^.6 ^ .2 .2 .2 .02 5
execute as @e[tag=projectile,tag=blitz_dash,scores={life=18..}] at @s run particle dust 1 1 0 1 ^ ^.9 ^.8 .2 .2 .2 .02 20
execute as @e[tag=projectile,tag=blitz_dash,scores={life=18..}] at @s run particle angry_villager ^ ^.6 ^.8 .2 .2 .2 .02 5
execute as @e[tag=projectile,tag=blitz_dash,scores={life=18..}] at @s run particle dust 1 1 0 1 ^ ^.9 ^1.6 .2 .2 .2 .02 20
...
execute as @e[tag=projectile,tag=blitz_dash,scores={life=18..}] at @s at @e[tag=enemy,distance=..1.4] run particle dust_color_transition 1 1 0 1 .7 .7 .7 ~ ~3 ~ 0 1 0 0 40

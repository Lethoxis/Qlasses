...
execute as @e[tag=geyser_instance] at @s run particle dust_color_transition .2 .6 1 2 0 0 1 ^ ^.2 ^3 .08 .08 .08 .01 4
execute as @e[tag=geyser_instance,scores={life=14..}] at @s run particle dust_color_transition .2 .6 1 2 0 0 1 ^ ^.2 ^-3 .08 .08 .08 .01 4
execute as @e[tag=geyser_instance] at @s run tp @s ~ ~ ~ ~5 ~
execute as @e[tag=geyser_instance,scores={life=14..}] at @s run tp @s ~ ~.45 ~ ~5 ~

execute as @e[tag=geyser_instance,scores={life=14..}] at @s run particle dust_color_transition .2 1 1 2 .2 .5 1 ^3 ^.2 ^ .08 .08 .08 .01 4
execute as @e[tag=geyser_instance,scores={life=14..}] at @s run particle dust_color_transition .2 1 1 2 .2 .5 1 ^-3 ^.2 ^ .08 .08 .08 .01 4
execute as @e[tag=geyser_instance] at @s run tp @s ~ ~ ~ ~5 ~
execute as @e[tag=geyser_instance,scores={life=14..}] at @s run tp @s ~ ~.45 ~ ~5 ~
...
execute as @e[tag=geyser_instance,scores={life=14..17}] at @s as @e[tag=enemy,distance=..3.5] at @s run particle dust_color_transition .2 1 1 1 .2 .5 1 ^ ^-1 ^ .04 .5 .04 .01 40

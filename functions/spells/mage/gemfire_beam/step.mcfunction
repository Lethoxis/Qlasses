...
execute as @e[tag=projectile,tag=gemfire_beam] at @s run particle dust_color_transition .6 0 1 2 1 .8 .3 ~ ~ ~ .2 .05 .2 1 4 force
execute as @e[tag=projectile,tag=gemfire_beam] at @s run particle dust_color_transition .8 .1 1 2 1 1 1 ~ ~ ~ .2 .05 .2 1 4 force
...
execute as @e[tag=projectile,tag=gemfire_beam] at @s at @e[tag=enemy,distance=..1.3] run particle dust_color_transition .6 0 1 1 1 .8 .3 ~ ~1.5 ~ .05 1.2 .05 1 50 force

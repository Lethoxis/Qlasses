...
##### Emerging
execute as @e[tag=projectile,tag=earthwall,scores={life=..9}] at @s run particle block pointed_dripstone ~ ~ ~ .4 1 .4 .01 20
...
execute as @e[tag=projectile,tag=earthwall,scores={life=150}] at @s run particle block pointed_dripstone ~ ~-1 ~ .6 1.2 .6 .01 200

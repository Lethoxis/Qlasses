...
execute as @e[tag=stonefall_deluge_stone] at @s run particle block pointed_dripstone ~ ~1.8 ~ 0 0 0 0 4
...
execute as @e[tag=stonefall_deluge_stone,tag=hit] at @s run particle item pointed_dripstone ~ ~.5 ~ .4 .4 .4 0 100

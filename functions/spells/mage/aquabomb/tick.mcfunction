...
execute as @a[tag=aquabombing,scores={jump=1..},nbt={OnGround:0b}] at @s run particle dust_color_transition 1 1 1 1 .1 .1 1 ~ ~.8 ~ .3 .4 .3 0 10
...
execute as @a[tag=aquabombing,scores={jump=1..},nbt={OnGround:1b}] at @s run summon area_effect_cloud ~ ~.03 ~ {Particle:"dust_color_transition .1 .7 1 1.3 1 1 1",Duration:6s,Radius:5}
execute as @a[tag=aquabombing,scores={jump=1..},nbt={OnGround:1b}] at @s run summon area_effect_cloud ~ ~.2 ~ {Particle:"splash",Duration:6s,Radius:5}
execute as @a[tag=aquabombing,scores={jump=1..},nbt={OnGround:1b}] at @s run summon area_effect_cloud ~ ~.2 ~ {Particle:"dripping_water",Duration:9s,Radius:5}

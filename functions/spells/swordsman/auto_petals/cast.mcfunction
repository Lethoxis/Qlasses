...
execute at @e[tag=auto_petals] run particle dust 1 .7 1 .8 ^-.8 ^.3 ^-.2 .1 .1 .1 0 5
execute at @e[tag=auto_petals] run particle dust 1 .7 1 .8 ^-.4 ^.15 ^ .1 .1 .1 0 5
execute at @e[tag=auto_petals] run particle dust 1 .7 1 .8 ^ ^ ^.2 .1 .1 .1 0 5
execute at @e[tag=auto_petals] run particle dust 1 .7 1 .8 ^.4 ^-.15 ^ .1 .1 .1 0 5
execute at @e[tag=auto_petals] run particle dust 1 .7 1 .8 ^.8 ^-.3 ^-.2 .1 .1 .1 0 5

...
execute as @e[tag=projectile,tag=vesuvius_instance,scores={life=..5}] at @s run particle block blackstone ~ ~ ~ .4 1 .4 .01 20
...
execute as @e[tag=projectile,tag=vesuvius_instance,scores={life=5..}] at @s run particle dust_color_transition 1 0 0 1 1 1 0 ^ ^-2 ^-.5 .5 1 .5 0 1
...
execute as @e[tag=projectile,tag=vesuvius_instance,scores={life=130..}] at @s run particle block blackstone ~ ~-1 ~ .6 1.2 .6 .01 40

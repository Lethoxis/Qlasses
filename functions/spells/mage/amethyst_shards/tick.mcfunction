...
execute as @e[tag=projectile,tag=amethyst_shards] at @s run particle dust .8 .7 .8 .5 ^ ^ ^ .02 .02 .02 0 2
execute as @e[tag=projectile,tag=amethyst_shards] at @s run particle dust .8 .7 .8 .5 ^ ^ ^-.5 .02 .02 .02 0 2
...
execute as @e[tag=projectile,tag=amethyst_shards,tag=hit,tag=!hitwall] at @s positioned ^ ^ ^1 run particle item large_amethyst_bud ~ ~ ~ .5 .5 .5 .3 40
execute as @e[tag=projectile,tag=amethyst_shards,tag=hit,tag=hitwall] at @s positioned ^ ^ ^1 run particle item large_amethyst_bud ~ ~ ~ .4 .4 .4 .1 20

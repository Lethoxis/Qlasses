...
#### VSFX
execute as @e[tag=pyrotectonics_erupt,scores={life=1}] at @s run particle dust_color_transition{from_color:[1.0, 0.0, 0.0], scale:2.7, to_color:[1.0, .7, 0.0]} ^ ^ ^1.5 0 0 0 1 1
...
execute as @e[tag=pyrotectonics_erupt,scores={life=1..}] at @s run summon area_effect_cloud ~ ~-1 ~ {Particle:{type:"flame"},Duration:6s,Radius:1.5}
...
execute as @e[tag=pyrotectonics_erupt,scores={life=1..}] at @s run particle dust{color:[1.0, .2, 0.0], scale:1.5} ~ ~ ~ .5 .4 .5 0.2 9

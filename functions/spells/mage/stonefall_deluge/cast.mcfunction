...
tag @a[scores={cast=14}] add spawnProjectile
function code:misc/player_spawn_projectile
execute as @a[scores={cast=14}] at @s run tag @e[tag=projectile,scores={life=0},sort=nearest,limit=1] add stonefall_deluge
execute as @a[scores={cast=14}] at @s run summon marker ~ ~ ~ {Tags:["passenger","stonefall_deluge_vfx","new","hasLife"]}
...
execute as @a[scores={cast=14}] at @s run playsound entity.generic.eat ambient @a ~ ~ ~ 1 0
execute as @a[scores={cast=14}] at @s run playsound ui.loom.select_pattern ambient @a ~ ~ ~ 1 0

...
execute as @a[tag=stonefall_deluge,scores={lc=1..}] at @s run playsound entity.generic.eat ambient @a ~ ~ ~ 1 0
execute as @a[tag=stonefall_deluge,scores={lc=1..}] at @s run playsound ui.loom.select_pattern ambient @a ~ ~ ~ 1 0

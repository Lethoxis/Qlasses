...
execute if entity @a[scores={cast=109}] run function code:spells/mage/himalaya/cast
execute if entity @a[scores={cast=110}] run function code:spells/mage/vesuvius/cast
execute if entity @a[scores={cast=111}] run function code:spells/mage/fuji/cast
...
execute if entity @a[scores={cast=304}] run function code:spells/mage/notch/cast


## Swordsman
execute if entity @a[scores={cast=1000..1002}] run function code:spells/swordsman/enchanted_path/cast

execute if entity @a[scores={cast=1900}] run function code:spells/swordsman/auto_petals/cast
execute if entity @a[scores={cast=1901}] run function code:spells/swordsman/auto_star/cast
execute if entity @a[scores={cast=1902}] run function code:spells/swordsman/auto_warden/cast

########################## CD ##########################
execute as @a[scores={lc=1..}] unless score @s autocd matches 1.. run scoreboard players operation @s autocd = @s autoCD
